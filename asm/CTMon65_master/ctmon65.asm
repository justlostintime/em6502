...
;
        ...
        db    REVISION+'2
        db    CR,LF
        db  "02/12/2023 update Justlostintime justlostintime@gmail.com"
        db    CR,LF
        db    "04/13/2022 by Bob Applegate K2UT/JustLostInTime"
        db    CR,LF
        db    "Authors: justlostintime@gmail.com,bob@corshamtech.com"
        db    CR,LF
        db  "Project @ , https://github.com/justlostintime/em6502"
        db    CR,LF,LF,0
;
;---------------------------------------------------------
