...
;
; 02/8/2022  - JustLostInTime
;	       added ability to remove disk file non-dsk
;
...
;=====================================================
; This Removes a file from the SD for writing.  On entry,
; X (MSB) and Y (LSB) point to a null-terminated
; filename to remove.  On return, C is clear if the file
; is removed, or C set if an error.
;
; Assumes write mode has been set.  Returns with it set.
;
DiskRemoveFile	lda	#PC_RM_FILE
		jmp	DiskOpen
;
;=====================================================
